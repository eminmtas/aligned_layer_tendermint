...
func init() {
	...
	proto.RegisterType((*MsgVerify)(nil), "lambchain.lambchain.MsgVerify")
	proto.RegisterType((*MsgVerifyResponse)(nil), "lambchain.lambchain.MsgVerifyResponse")
}
...
var fileDescriptor_4e754d0b62f92212 = []byte{
	...
	,
}
...
func (c *msgClient) Verify(ctx context.Context, in *MsgVerify, opts ...grpc.CallOption) (*MsgVerifyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lambchain.lambchain.Msg/Verify", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Verify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lambchain.lambchain.Msg/Verify",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
